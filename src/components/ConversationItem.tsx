...
export function ConversationItem({ conversation, onClick, isActive }: ConversationItemProps) {
  ...
  return (
    ...
    >
      ...
      {/* Avatar */}
      <div className={cn(
        'flex-shrink-0 w-[52px] h-[52px] rounded-full flex items-center justify-center relative z-10',
      ...
      <div className="flex-1 min-w-0 relative z-10">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-1.5 flex-shrink-0">
            ...
            {hasUnread && (
              <span className="min-w-[22px] h-[22px] rounded-full bg-primary text-primary-foreground text-xs font-bold flex items-center justify-center px-1.5">
